...
function agregar(){
    ...
    productos.push(new Producto(prompt("Agrega algun nuevo producto"),prompt("Agrega el precio del producto"),prompt("agrega la cantidad del producto")))
...
//     productos.push(new Producto(prompt("Agrega algun nuevo producto"), aca deberia ir otro prompt pidiendo el precio, otro mas pidiendo cantidad))
